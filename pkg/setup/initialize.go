...
func GenerateCerts(ctx context.Context, serviceCIDR, certificatesDir string, options *config.VirtualClusterConfig) error {
	...
	kubeadmConfig, err := GenerateInitKubeadmConfig(ctx, serviceCIDR, certificatesDir, options)
	if err != nil {
...
func GenerateInitKubeadmConfig(ctx context.Context, serviceCIDR, certificatesDir string, options *config.VirtualClusterConfig) (*kubeadmapi.InitConfiguration, error) {

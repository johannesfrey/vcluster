...
type LegacyPlatformConfig struct {
	...
	// +optional
	AutoSleep *LegacyAutoSleep `json:"autoSleep,omitempty"`

	// AutoDelete holds configuration for automatic delete
	// Deprecated: Use top-level Deletion instead.
	// +optional
	AutoDelete *LegacyAutoDelete `json:"autoDelete,omitempty"`
	...
	// +optional
	AutoSnapshot *LegacyAutoSnapshot `json:"autoSnapshot,omitempty"`
}

// LegacyAutoSleep holds configuration for automatic sleep and wakeup.
//
// Deprecated: Use top-level sleepMode instead.
type LegacyAutoSleep struct {
	...
	// +optional
	AutoWakeup *LegacyAutoWakeup `json:"autoWakeup,omitempty"`
}

// LegacyAutoWakeup holds configuration for automatic wakeup.
//
// Deprecated: Use top-level sleepMode.autoWakeup instead.
type LegacyAutoWakeup struct {
...
type LegacyAutoSnapshot struct {
	...
	// +optional
	Volumes LegacyVolumeSnapshot `json:"volumes"`

	// Storage specifies a set of configuration where the snapshot will be stored
	// +optional
	Storage LegacyScheduledSnapshotStorage `json:"storage,omitempty"`
...
type LegacyContainerStorage struct {
	...
	// +optional
	Volume LegacyContainerStorageVolume `json:"volume,omitempty"`
}
...
type LegacySleepMode struct {
	...
	AutoSleep  *SleepAuto       `json:"autoSleep,omitempty"  yaml:"autoSleep,omitempty"`
	AutoWakeup *SleepAutoWakeup `json:"autoWakeup,omitempty" yaml:"autoWakeup,omitempty"`
}

...
type SleepMode struct {
	...
	AutoWakeup SleepModeAutoWakeup `json:"autoWakeup,omitempty"`
}
...
// SleepModeAutoWakeup holds the cron schedule to wake workloads automatically
type SleepModeAutoWakeup struct {
	Schedule string `json:"schedule,omitempty"`
}
...
type Snapshots struct {
	// Enabled defines whether auto snapshot is enabled for the virtual cluster
	// +optional
	Enabled bool `json:"enabled,omitempty"`
	...
	// +optional
	Volumes SnapshotVolumes `json:"volumes,omitempty"`
